<x-navbar>
    <div class="dashboard-layout-wrapper" style="display: flex; gap: 24px; align-items: flex-start; width: 100%;">
        ...
        <!-- Sidebar bên trái -->
        <aside class="nav-sidebar" style="width: 260px; flex-shrink: 0; background: #ffffff; solid #f1f5f9; padding: 20px; box-shadow: 0 4px 20px -2px rgba(0, 0, 0, 0.03);">
            ...
            <div class="sidebar-section" style="margin-bottom: 24px;">
                ...
                <div class="project-list" style="display: flex; flex-direction: column; gap: 4px;">
                    <a href="#" class="project-item" style="display: flex; align-items: center; gap: 10px; padding: 8px 12px; border-radius: 8px; color: #475569; text-decoration: none; font-size: 0.9rem; font-weight: 500; transition: background 0.2s;">
